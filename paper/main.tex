...
\end{center}
\hspace{2em}衷心感谢教师李晓花老师在本次统计建模大赛全程中给予的悉心指导与及时帮助。李老师在选题方向、排版规范和公式选择等关键环节提出了许多宝贵建议，使我们在研究思路和论文撰写上受益匪浅。

感谢队友于重阳、龚旭和余博的密切协作。余博承担了数据处理与图表绘制工作，提供了最初的算法代码；龚旭负责确定选题、排版校对与论文架构设计，引入了按出口国聚类的稳健标准误、PPML 估计方法与分数响应模型（FRM），完成了基准回归模型的替换与稳健性检验体系的搭建；于重阳负责论文文稿的编写与修改，撰写了完整的论文初稿。三人各司其职、相互配合，共同完成了本次研究。
