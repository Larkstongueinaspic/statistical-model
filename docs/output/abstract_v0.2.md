...
- pooled `ln(import_value+1)` 模型中，`US_Post2018`、`US_Post2022`、`US_Post2023` 分别为 0.1766 (p=0.0022)、0.0257 (p=0.5890)、-0.1311 (p=0.0116)。
...
- 改用 `asinh(import_value)` 后，`US_Post2023` 为 -0.1193 (p=0.0399)。
- 剔除 `2020-2021` 后，`US_Post2023` 为 -0.1311 (p=0.0117)。
- 只保留 2024 年前十来源国加美国的收窄对照组后，`US_Post2023` 为 -0.1270 (p=0.3155)。
